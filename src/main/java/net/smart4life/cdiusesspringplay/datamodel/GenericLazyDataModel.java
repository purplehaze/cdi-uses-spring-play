package net.smart4life.cdiusesspringplay.datamodel;

import net.smart4life.cdiusesspringplay.entity.Idable;
import net.smart4life.cdiusesspringplay.service.DataModelFindAble;
	...
	public List<T> load(int first, int pageSize, List<SortMeta> multiSortMeta, Map<String, Object> filters) {
		try
		{
			...
			if(multiSortMeta != null && multiSortMeta.size() > 0){
				...
				filter.setSortMeta(new net.smart4life.cdiusesspringplay.datamodel.SortMeta(sField, sDirection));
			}
